...
export default function SpinningCircle({
  ...
  return (
    <div className="flex items-center relative top-1/2 left-1/2 -translate-x-1/2 -translate-y-[100px] md:-translate-y-[180px] justify-center  bg-tranparent z-50 p-8">
